...
const AdminDashboard = () => {
  ...
  return (
    ...
    >
      {loading && <div style={{ marginBottom: "1rem" }}>Loading data…</div>}
      {error && (
        <div style={{ padding: "1rem", backgroundColor: "rgba(255, 95, 86, 0.1)", color: "var(--mac-red)", borderRadius: "8px", marginBottom: "1rem", display: "flex", justifyContent: "space-between" }}>
          {error}
          <button style={{ background: "none", border: "none", color: "var(--mac-red)", cursor: "pointer" }} onClick={() => setError("")}>✕</button>
        </div>
      )}
      {renderContent()}
    </AppDashboardLayout>
